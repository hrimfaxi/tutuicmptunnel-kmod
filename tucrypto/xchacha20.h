 ...
 *
 */
void xchacha_encrypt_bytes(XChaCha_ctx *ctx, const uint8_t *plaintext, uint8_t *ciphertext, uint32_t msglen);
 ...
 *
 */
void xchacha_decrypt_bytes(XChaCha_ctx *ctx, const uint8_t *ciphertext, uint8_t *plaintext, uint32_t msglen);
...
#define xchacha_encrypt_blocks(ctx, plaintext, ciphertext, blocks)                                                             \
  xchacha_encrypt_bytes(ctx, plaintext, ciphertext, (blocks) * XCHACHA_BLOCKLENGTH)

#define xchacha_decrypt_blocks(ctx, ciphertext, plaintext, blocks)                                                             \
  xchacha_decrypt_bytes(ctx, ciphertext, plaintext, (blocks) * XCHACHA_BLOCKLENGTH)

#define xchacha_keystream_blocks(ctx, keystream, blocks) xchacha_keystream_bytes(ctx, keystream, (blocks) * XCHACHA_BLOCKLENGTH)
